...
5. **[5-args-a.ts](./examples/5-args-a.ts)**: An example of how to run commands using arguments.
6. **[6-args-b.ts](./examples/6-args-b.ts)**: Another example of how to run commands using arguments.
