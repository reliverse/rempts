...
import { Separator } from "~/core/index.js";
...
describe("select prompt", () => {
  ...
  it("allow customizing short names after selection", async () => {
    ...
    const { answer, events, getScreen } = await render(select, {
      ...
      choices: [
        {
          name: "2cc9e311 (HEAD -> main) Fix(@reliverse/prompts): Ensure no mutation of the question",
          value: "2cc9e311",
          short: "2cc9e311",
        },
        {
          name: "3272b94a (origin/main) Fix(@reliverse/prompts): Fix close method not required",
          value: "3272b94a",
          short: "3272b94a",
        },
        {
    ...
    expect(getScreen()).toMatchInlineSnapshot(`
      ...
      ❯ 2cc9e311 (HEAD -> main) Fix(@reliverse/prompts): Ensure no mutation of the question
        3272b94a (origin/main) Fix(@reliverse/prompts): Fix close method not required
