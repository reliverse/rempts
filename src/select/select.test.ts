...
describe("select prompt", () => {
  it("use arrow keys to select an option", async () => {
    const { answer, events, getScreen } = await render(select /* 
      Argument of type '<Value>(config: { message: string; choices: readonly (string | Separator)[]; pageSize?: number; loop?: boolean; default?: unknown; theme?: { icon?: { cursor?: string; }; style?: { disabled?: {}; description?: {}; answer?: {}; message?: {}; ... 4 more ...; key?: {}; }; helpMode?: "always" | ... 1 more ... | "auto"; p...' is not assignable to parameter of type 'Prompt<unknown, { readonly message: "Select a number"; readonly choices: readonly [{ readonly value: 1; }, { readonly value: 2; }, { readonly value: 3; }, { readonly value: 4; }, { readonly value: 5; }, { readonly value: 6; }, ... 5 more ..., { ...; }]; }>'.
  Types of parameters 'config' and 'config' are incompatible.
    Type '{ readonly message: "Select a number"; readonly choices: readonly [{ readonly value: 1; }, { readonly value: 2; }, { readonly value: 3; }, { readonly value: 4; }, { readonly value: 5; }, { readonly value: 6; }, ... 5 more ..., { ...; }]; }' is not assignable to type '{ message: string; choices: readonly (string | Separator)[]; pageSize?: number; loop?: boolean; default?: unknown; theme?: { icon?: { cursor?: string; }; style?: { disabled?: {}; description?: {}; answer?: {}; message?: {}; ... 4 more ...; key?: {}; }; helpMode?: "always" | ... 1 more ... | "auto"; prefix?: string |...'.
      Types of property 'choices' are incompatible.
        Type 'readonly [{ readonly value: 1; }, { readonly value: 2; }, { readonly value: 3; }, { readonly value: 4; }, { readonly value: 5; }, { readonly value: 6; }, { readonly value: 7; }, { readonly value: 8; }, { ...; }, { ...; }, { ...; }, { ...; }]' is not assignable to type 'readonly (string | Separator)[]'.ts(2345)
      */, {
  ...
  it("allow selecting the first option", async () => {
    const { answer, events, getScreen } = await render(select /* 
      Argument of type '<Value>(config: { message: string; choices: readonly (string | Separator)[]; pageSize?: number; loop?: boolean; default?: unknown; theme?: { icon?: { cursor?: string; }; style?: { disabled?: {}; description?: {}; answer?: {}; message?: {}; ... 4 more ...; key?: {}; }; helpMode?: "always" | ... 1 more ... | "auto"; p...' is not assignable to parameter of type 'Prompt<unknown, { readonly message: "Select a number"; readonly choices: ({ readonly value: 1; } | { readonly value: 2; } | { readonly value: 3; } | { readonly value: 4; } | { readonly value: 5; } | { readonly value: 6; } | ... 5 more ... | { ...; })[]; }>'.
  Types of parameters 'config' and 'config' are incompatible.
    Type '{ readonly message: "Select a number"; readonly choices: ({ readonly value: 1; } | { readonly value: 2; } | { readonly value: 3; } | { readonly value: 4; } | { readonly value: 5; } | { readonly value: 6; } | ... 5 more ... | { ...; })[]; }' is not assignable to type '{ message: string; choices: readonly (string | Separator)[]; pageSize?: number; loop?: boolean; default?: unknown; theme?: { icon?: { cursor?: string; }; style?: { disabled?: {}; description?: {}; answer?: {}; message?: {}; ... 4 more ...; key?: {}; }; helpMode?: "always" | ... 1 more ... | "auto"; prefix?: string |...'.
      Types of property 'choices' are incompatible.
        Type '({ readonly value: 1; } | { readonly value: 2; } | { readonly value: 3; } | { readonly value: 4; } | { readonly value: 5; } | { readonly value: 6; } | { readonly value: 7; } | { readonly value: 8; } | { ...; } | { ...; } | { ...; } | { ...; })[]' is not assignable to type 'readonly (string | Separator)[]'.
          Type '{ readonly value: 1; } | { readonly value: 2; } | { readonly value: 3; } | { readonly value: 4; } | { readonly value: 5; } | { readonly value: 6; } | { readonly value: 7; } | { readonly value: 8; } | { ...; } | { ...; } | { ...; } | { ...; }' is not assignable to type 'string | Separator'.ts(2345)
  ...
  it("allow customizing short names after selection", async () => {
    const { answer, events, getScreen } = await render(select, {
      ...
      choices: [
        {
          name: "2cc9e311 (HEAD -> main) Fix(relinka): Ensure no mutation of the question",
          value: "2cc9e311",
          short: "2cc9e311",
        },
        {
          name: "3272b94a (origin/main) Fix(relinka): Fix close method not required",
          value: "3272b94a",
          short: "3272b94a",
        },
        {
    ...
    expect(getScreen()).toMatchInlineSnapshot(`
      ...
      ❯ 2cc9e311 (HEAD -> main) Fix(relinka): Ensure no mutation of the question
        3272b94a (origin/main) Fix(relinka): Fix close method not required
