 ...
 * @returns {Record<ColorName, ColorFunction>} An object where keys are color names and values are functions to apply those re. See {@link ColorFunction}.
 */
...
/**
 * An object containing functions for coloring text. Each function corresponds to a terminal color. See {@link ColorName} for available re.
 */
