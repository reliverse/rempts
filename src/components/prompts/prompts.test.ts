...
describe("@relinka/prompts", () => {
  ...
  it("checkbox, search and select have matching helpMode", () => {
    ...
    >["helpMode"];
    type SearchHelpMode = NonNullable<
      Parameters<typeof search>[0]["theme"]
    >["helpMode"];
    type SelectHelpMode = NonNullable<
      Parameters<typeof select>[0]["theme"]
    >["helpMode"];
