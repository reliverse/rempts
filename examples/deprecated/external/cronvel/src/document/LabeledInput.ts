...
function LabeledInput(options) {
  ...
  if (this.elementType === "LabeledInput" && !options.noDraw) {
    this.draw();
  }
}
...
LabeledInput.prototype.multiLineEditableTextBoxKeyBindings = Object.assign(
  {},
  LabeledInput.prototype.editableTextBoxKeyBindings,
  {
    ENTER: "newLine",
...
LabeledInput.prototype.initTextInput = function (options) {
  if (options.inputKeyBindings) {
    this.inputKeyBindings = options.inputKeyBindings;
  } else if (options.allowNewLine) {
    this.inputKeyBindings = this.multiLineEditableTextBoxKeyBindings;
  } else {
    this.inputKeyBindings = this.editableTextBoxKeyBindings;
  }
...
LabeledInput.prototype.initSelectInput = function (options) {
  if (options.inputKeyBindings) {
    ...
    this.inputKeyBindings = this.selectListKeyBindings;
  }
...
LabeledInput.prototype.initSelectMultiInput = function (options) {
  if (options.inputKeyBindings) {
    ...
    this.inputKeyBindings = this.selectListMultiKeyBindings;
  }
...
LabeledInput.prototype.getValue = function () {
  return this.input.getValue();
};
LabeledInput.prototype.setValue = function (value, dontDraw) {
  return this.input.setValue(value, dontDraw);
};
LabeledInput.prototype.getContent = function () {
  return this.input.getContent();
};
LabeledInput.prototype.setContent = function (content, hasMarkup, dontDraw) {
  return this.input.setContent(content, hasMarkup, dontDraw);
};

LabeledInput.prototype.drawSelfCursor = function () {
  if (this.input.drawSelfCursor) {
    this.input.drawSelfCursor();
  }
};

LabeledInput.prototype.onKey = function (key, altKeys, data) {
  // Give full priority to the child input
  if (this.input.emit("key", key, altKeys, data).interrupt) {
    return true;
  }
