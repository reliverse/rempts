                ...
                if (subSubTree) {
                  ...
                  if (event !== "none") {
                    this.emit(
                      ...
                      subSubTree.arg !== undefined
                        ? subSubTree.arg
                        : basePtr.arg !== undefined
                          ? basePtr.arg
                          : subTree.arg /* eslint-disable-line no-nested-ternary */,
                      subSubTree.extraArgs ||
                        basePtr.extraArgs ||
                        subTree.extraArgs ||
                        defaultArgs(
                          args.slice(argIndex + 1),
                          subSubTree.defaultExtraArgs,
                        ),
                    );
                  }
