...
function createBackground() {
  ...
  createBackgroundStars(
    sprites.background.width * sprites.background.height * 0.004,
  );
  createBackgroundTrails(
    sprites.background.width * sprites.background.height * 0.008,
  );
  createBackgroundPlanets(
    sprites.background.width * sprites.background.height * 0.0001,
  );
}
...
function createSpaceship() {
  ...
  sprites.spaceship = ScreenBuffer.loadSync(
    __dirname + "/data/spaceship1.sbuf",
  );

  sprites.spaceship.x = 3;
  sprites.spaceship.y = Math.floor(
    viewport.height / 2 - sprites.spaceship.height / 2,
  );
}
