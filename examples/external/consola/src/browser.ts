 ...
 * The options can override the default reporter and prompt behavior. See {@link ConsolaOptions}.
 * @returns {ConsolaInstance} A new Consola instance optimized for use in browser environments.
 */
