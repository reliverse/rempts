...
function InlineInput(options) {
    ...
    if (options.prompt) {
        ...
        if (size.height > 1) {
            ...
            options.firstLineRightShift =
                this.promptTextBox.textBuffer.buffer[this.promptTextBox.textBuffer.buffer.length - 1].length;
        }
        else {
    ...
    this.useAutoCompleteHint = !!(this.autoComplete &&
    ...
    this.useAutoCompleteMenu = !!(this.autoComplete &&
