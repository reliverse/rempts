...
Button.prototype.setContent = function (content, hasMarkup, dontDraw = false, dontResize = false) {
    ...
    if (!content || typeof content !== "object" || Array.isArray(content)) {
        ...
        if (content.internal) {
            ...
            this.turnedOffBlurContent = this._toContentArray(content.turnedOffBlurContent ??
            ...
            this.turnedOffFocusContent = this._toContentArray(content.turnedOffFocusContent ??
                content.turnedOffContent ??
                this.content);
        }
        else {
