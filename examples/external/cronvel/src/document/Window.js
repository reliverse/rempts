...
function Window(options) {
    ...
    if (options.frameChars) {
        ...
        else if (typeof options.frameChars === "string" &&
...
Window.prototype.preDrawSelf = function () {
    var y, title, titleWidth, vFrame, titleMaxWidth = this.outputWidth - 8;
    // Draw the top border
    if (this.content && titleMaxWidth >= 1) {
        ...
        this.outputDst.put({ x: this.outputX, y: this.outputY, markup: this.contentHasMarkup }, this.frameChars.topLeft +
        ...
        this.outputDst.put({ x: this.outputX, y: this.outputY }, this.frameChars.topLeft +
            this.frameChars.horizontal.repeat(this.outputWidth - 2) +
            this.frameChars.topRight);
    }
    // Draw the bottom border
    this.outputDst.put({ x: this.outputX, y: this.outputY + this.outputHeight - 1 }, this.frameChars.bottomLeft +
        this.frameChars.horizontal.repeat(this.outputWidth - 2) +
