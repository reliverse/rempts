...
image.shrinkNdarrayImage = function shrinkNdarrayImage(pixels, options) {
    ...
    var xDst, yDst, xSrc, xSrcMin, xSrcMax, ySrc, ySrcMin, ySrcMax, r, g, b, a, count, hasAlpha = pixels.shape[2] === 4;
    var shrinkedPixels = ndarray(new Uint8Array(dstWidth * dstHeight * pixels.shape[2]), [dstWidth, dstHeight, pixels.shape[2]]);
