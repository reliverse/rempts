...
Document.prototype.focusNext = function () {
    ...
    for (;;) {
        ...
        if (startingElement === currentElement ||
    ...
    for (;;) {
        if (currentElement.parent) {
            ...
            if (index - 1 >= 0) {
                ...
                currentElement =
                    currentElement.parent.children[currentElement.parent.children.length - 1];
                while (currentElement.children.length && !currentElement.noChildFocus) {
                    currentElement =
                        currentElement.children[currentElement.children.length - 1];
                }
...
*/
const COMMON_MOUSE_AWARE_FILTER = (element) => element.listenerCount("click") ||
...
Document.prototype.mouseDrag = function (data) {
    ...
    if (this.draggingData.element) {
        ...
        if (emitDrag) {
            this.draggingData.element.emit("drag", {
...
Document.prototype.mouseDragEnd = function (data) {
    ...
    if (this.draggingData.element) {
        this.draggingData.element.emit("dragEnd", {
            xFrom: this.draggingData.xFrom + this.draggingData.localDx,
            yFrom: this.draggingData.yFrom + this.draggingData.localDy,
