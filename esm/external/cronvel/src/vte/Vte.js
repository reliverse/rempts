...
Vte.prototype.run = function (command, args) {
    var childPty, child, promise = new Promise();
...
Vte.prototype.putChar = function (char) {
    ...
    log("putChar:", charCode <= 0x1f || charCode === 0x7f ? "(ctrl)" : char, charCode >= 0x10
        ? "\\x" + charCode.toString(16)
        : "\\x0" + charCode.toString(16), "at:", this.cx, this.cy);
