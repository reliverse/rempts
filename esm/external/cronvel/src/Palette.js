...
Palette.prototype.generateAdaptive = function () {
    ...
    var i, j, z, register, baseChromaColors, chromaColor, saturationMark, lightnessMark, suffix;
...
Palette.prototype.addColor = function (register, chromaColor, names, prefix = "", suffix = "") {
    var targetRegister, [r, g, b] = chromaColor.rgb();
    ...
    if (this.term.support.trueColor) {
        ...
        targetRegister = this.term.registerForRgb({ r, g, b }, r === g && g === b ? 232 : 0, // minRegister is the start of the grayscale if r=g=b
        255);
