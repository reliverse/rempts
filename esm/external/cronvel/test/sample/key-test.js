...
term.on("key", (name, matches, data) => {
    console.log("Key:", name, ", length:", name.length, ", all matches:", matches, ", is character:", data.isCharacter, ", codepoint:", data.codepoint ? data.codepoint.toString(16) : "", ", meta:", data.meta, ", buffer:", Buffer.isBuffer(data.code) ? data.code : data.code.toString(16));
    switch (name) {
        case "CTRL_C":
