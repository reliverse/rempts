...
describe("prompt", () => {
    ...
    it("should validate text input with schema", async () => {
        ...
        expect(console.log).toHaveBeenCalledWith("String must have a minimum length of 5");
    });
    ...
    it("should handle invalid selection input and re-prompt", async () => {
        ...
        expect(console.log).toHaveBeenCalledWith("Please enter a number between 1 and 3.");
    });
    ...
    it("should handle invalid multiple selections and re-prompt", async () => {
        ...
        expect(console.log).toHaveBeenCalledWith("Invalid selections: 0, 4. Please enter numbers between 1 and 3.");
    });
