...
export async function startPrompt(options, currentState = {
    ...
    const { title, titleColor, titleTypography, titleVariant, content, contentColor, contentTypography, contentVariant, variantOptions, } = options;
    ...
    process.stdout.write(`${erase.line}| ${currentState.symbol} ${styledTitle}\n`);
    if (styledContent) {
