...
import { relinka, createRelinka } from "~/create.js";
...
async function detailedExample() {
    // box
    relinka.box("=== box ===");
    relinka.box(`Welcome to @reliverse/relinka! You're going to test an 'experimental' example.`);
    relinka.box({
    ...
    try {
        ...
        console.log("You aborted, having chosen:", error.message);
    }
    // prompt
    relinka.box("=== prompt ===");
    ...
    relinka.log("We can also _underline_ words but not_this or this should_not_be_underlined!");
    // Nonstandard error
